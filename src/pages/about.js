                ...
                <Layout className="pt-16">
                    ...
                    <div className="grid w-full grid-cols-8 gap-16">
                        ...
                        <div className="relative col-span-3 h-max rounded-2xl border-2 border-solid border-dark  bg-light p-8 dark:border-light dark:bg-dark">
                            <div className="absolute  top-0 -right-3 -z-10  rounded-[2rem] rounded-br-3xl  bg-dark dark:bg-light">
                            </div>
                            <Image src={aboutMe} alt="About Edward Martin" className="w-full h-auto rounded-2xl" />
                        </div>
